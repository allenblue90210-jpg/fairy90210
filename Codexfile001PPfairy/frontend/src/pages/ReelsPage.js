...
export default function ReelsPage() {
  ...
  useEffect(() => {
    const fetchReels = async () => {
      // Mocking reels data since backend is down
      const mockReels = Array.from({ length: 5 }).map((_, i) => ({
        id: i,
        username: `reel_star_${i}`,
        user_avatar: `https://api.dicebear.com/7.x/avataaars/svg?seed=reeluser${i}`,
        video_thumbnail: `https://picsum.photos/seed/reel${i}/600/1000`,
        caption: `Check out this amazing view! #reels #fairy #${i}`,
        likes_count: 5000 + i * 100,
        comments_count: 200 + i,
        music: `Original Audio - Reel Star ${i}`,
      }));
