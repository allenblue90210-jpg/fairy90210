...
export default function ProfilePage() {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      // Mocking profile data for demonstration since backend is down
      const mockProfile = {
        username: "allen_blue",
        display_name: "Allen Blue",
        bio: "Exploring the digital fairy world. ✨ | Fullstack Enthusiast",
        avatar_url: "https://api.dicebear.com/7.x/avataaars/svg?seed=Allen",
        is_verified: true,
        posts_count: 42,
        ...
        posts: Array.from({ length: 9 }).map((_, i) => ({
          id: i,
          image_url: `https://picsum.photos/seed/${i + 100}/600/600`,
